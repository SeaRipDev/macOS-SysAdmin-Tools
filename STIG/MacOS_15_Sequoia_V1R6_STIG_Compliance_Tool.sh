...
#
# Version 2.5 (02/26/26)
# - Updated to V1R6: Added APPL-15-004022 (sudo timestamp_timeout=0)
# - Added APPL-15-004060 (sudoers timestamp_type=tty)
# - Added APPL-15-999999 (security updates within 30 days, manual review)
# - Removed APPL-15-002130 (CD/DVD sharing check, no longer in V1R6 STIG)
####################################################################################################
# ==========================
# Script Supported STIG Version
# ==========================
STIG_VERSION="MACOS 15 (SEQUOIA) V1R6" # [ Do Not Adjust ]
...
Manual_Review_Checks=("APPL-15-002022" "APPL-15-005120" "APPL-15-000012" "APPL-15-003001" "APPL-15-003013" "APPL-15-003050" "APPL-15-003051" "APPL-15-003052" "APPL-15-999999") # Example: Manual_Review_Checks=("APPL-15-002052" "APPL-15-002051")
...
# APPL-15-002130 removed in V1R6 (CD/DVD sharing check no longer required)
...
execute_and_log "$check_name" "$check_command" "$expected_result" "$simple_name" "$severity" "$fix_command" "$requires_mdm"
##############################################
check_name="APPL-15-004022"
simple_name="sudo_timeout_configure"
...
##############################################
check_name="APPL-15-004060"
simple_name="sudoers_timestamp_type_configure"
...
##############################################
check_name="APPL-15-999999"
simple_name="os_security_update_install"
check_command="/usr/bin/sw_vers -productVersion"
expected_result="Manual Review Required"
severity="CAT II"
fix_command="Install the latest macOS security updates via System Settings > General > Software Update"
requires_mdm="false"
